...
lp=lm?'/php-config/'+lm[1]:'/php-config';
function load(){if(idx)return Promise.resolve();var sp=lm?'/php-config/'+lm[1]+'/search-index.json':'/php-config/search-index.json';return fetch(sp).then(function(r){return r.json()}).then(function(d){idx=d.entries||[]}).catch(function(){idx=[]})}
