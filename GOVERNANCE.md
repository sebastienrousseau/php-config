...
This document describes how @sebastienrousseau/php-config is run: who decides what, how
...
@sebastienrousseau/php-config is **maintainer-led**. As of the current release line it has a single
