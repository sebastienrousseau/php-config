# `@sebastienrousseau/php-config` Examples Catalog

This directory provides runnable, standalone examples covering **100% of the functionalities and features** provided by `@sebastienrousseau/php-config`.
...
- [x] **.php-cs-fixer.php**: Standardized rule preset
- [x] **phpstan.neon**: Standardized rule preset
