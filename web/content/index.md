...
screenshot_alt: "@sebastienrousseau/php-config architecture and rule enforcement."
footer_note: "@sebastienrousseau/php-config is part of the @sebastienrousseau/config suite. Published under Apache-2.0 OR MIT."
copyright: "© 2026 Sebastien Rousseau. Licensed under Apache-2.0 OR MIT."
translation_key: "home"
title: "@sebastienrousseau/php-config — Shareable PHP configuration standards for PHP-CS-Fixer, PHPStan, and Psalm."
description: "Shareable PHP configuration providing standardized PHP-CS-Fixer, PHPStan, and Psalm rules adhering to modern 2026 standards."
keywords: "php-config, php, php-cs-fixer, phpstan, psalm, psr-12, per-cs, developer tools, sebastien rousseau, standard"
hero_tag: "v0.0.1"
hero_tagline: "Standardized PER-CS 2.0 / PSR-12 formatting and Level 8 PHPStan analysis"
headline: "@sebastienrousseau/php-config"
lead: "Shareable PHP configuration providing standardized PHP-CS-Fixer, PHPStan, and Psalm rules adhering to modern 2026 standards."
cta_primary: "Install @sebastienrousseau/php-config"
...
snippet_caption: "Install @sebastienrousseau/php-config"
snippet_code: "npm install --save-dev @sebastienrousseau/php-config"
features_h: "Key capabilities"
features_lead: "Engineered for modern PHP 8.2+ enterprise applications."
f1_h: "PER-CS 2.0 Standards"
f1_body: "Standardized .php-cs-fixer.php enforcing strict typing, short array syntax, and PSR guidelines."
f2_h: "Level 8 PHPStan Analysis"
f2_body: "Configured phpstan.neon enforcing strong static typing and eliminating runtime type bugs."
