...
- Added a `native-validate` CI job that installs the real toolchain (php-cs-fixer, phpstan) and validates the shipped presets.
- Corrected the OpenSSF Best Practices badge, which pointed at another project.
## [0.0.1] - 2026-09-09

### Added

- Initial release of `@sebastienrousseau/php-config` conforming to REPO-STANDARD.
- Standardized PHP configuration presets: `.php-cs-fixer.php`, `phpstan.neon`.
